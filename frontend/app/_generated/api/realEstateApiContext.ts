...
import type { QueryOperation } from "./realEstateApiComponents";

export type RealEstateApiContext<
 ...
 */
export function useRealEstateApiContext<
  TQueryFnData = unknown,
  TError = DefaultError,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey,
>(
  _queryOptions?: Omit<
    ...
    "queryKey" | "queryFn"
  >,
): RealEstateApiContext<TQueryFnData, TError, TData, TQueryKey> {
  return {
    fetcherOptions: {},
    queryOptions: {},
  };
